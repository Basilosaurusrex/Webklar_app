        ...
        <div className="max-w-3xl w-full mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/80 rounded-2xl shadow-2xl p-6 flex flex-col items-center">
              ...
              <div className="text-sm text-gray-800 mb-1">kenso@webklar.com</div>
              <div className="text-sm text-gray-800">+49 123 456789</div>
            </div>
            {/* Karte 2 */}
            <div className="bg-white/80 rounded-2xl shadow-2xl p-6 flex flex-col items-center">
              <div className="w-20 h-20 rounded-full bg-gray-200 mb-4 flex items-center justify-center text-3xl text-gray-400">👤</div>
              ...
              <div className="text-sm text-gray-800 mb-1">Justin@webklar.com</div>
              <div className="text-sm text-gray-800">+49 987 654321</div>
            </div>
          </div>
        </div>
      </div>
