...
export default function AboutServicePage() {
  ...
  return (
    <div className="min-h-screen overflow-hidden" style={{ backgroundColor: colors.background }}>
      ...
      <nav className="fixed top-10 left-0 right-0 z-40 backdrop-blur-md">
        <div className="flex justify-between items-center px-4 sm:px-8 py-4 max-w-7xl mx-auto">
          ...
          <Button 
            className="rounded-full font-semibold px-4 sm:px-6 py-2 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            style={{ 
              backgroundColor: colors.primary,
              color: colors.background
            }}
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div ref={heroRef} className="relative z-20 px-4 sm:px-8 py-32 max-w-7xl mx-auto text-center">
          ...
          <div className={`flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 transition-all duration-1000 delay-500 ${
            ...
            <div 
              onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
              className="w-12 sm:w-16 h-12 sm:h-16 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 cursor-pointer"
              style={{ backgroundColor: colors.tertiary }}
            >
              <MessageCircle className="w-6 sm:w-8 h-6 sm:h-8" style={{ color: colors.primary }} />
            </div>
          </div>
